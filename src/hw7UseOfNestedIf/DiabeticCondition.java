...
public class DiabeticCondition {
	 ...
	 * the link below.
	 * 
	 * HW07B: Create a project --- "GithubDemo". Create a package name --
	 * "gitHub demo". Create a class --- "HelloGitHub". Inside the class, type main
	 * method and under it print "I know how to create a separate remote repository
	 * in Github and can push my project GithubDemo, without the help of anyone".
	 * Organize code, avoid white space, and push the project to GitHub. Paste the
	 * link below without the help of anyone else.
	 * 
	 * 
	 * 
	 */
