...
executes only when the outer if block condition is true.
...
operands. It can be used to replace multiple lines of code with a single line. It is often used to replace simple if else statements:
...
public class InfoConditionalStatement {
	...
	public static void main(String[] args) {
		...
		String any= 1<10? "imran":"ahmed"; //  any <-- imran(because 1 < 10 is true)
	}
